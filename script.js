...
const translations = {
  en: {
    ...
    'step.1.desc': 'Create a page with "icon" in its name. Add top-level frames ending with <code>Outlined</code>, <code>Filled</code>, or <code>Colored</code>. Name components in PascalCase. Keep masks out — use centered strokes and turn off Clip content.',
  ...
  zh: {
    ...
    'step.1.desc': '创建名称包含 "icon" 的页面。顶层 Frame 以 <code>Outlined</code>、<code>Filled</code> 或 <code>Colored</code> 结尾。组件使用大驼峰命名。不要带蒙版——描边对齐用「居中」，关闭「裁剪内容」。',
